<template>
    <div class="p-2">
        ...
        <!-- 表单区域 -->
        <TestEmployeeModal ref="registerModal" @success="handleSuccess"></TestEmployeeModal>
    </div>
</template>

<script lang="ts" name="biz-testEmployee" setup>
import { ref, reactive } from 'vue';
import { BasicTable, useTable, TableAction } from '/@/components/Table';
import { useListPage } from '/@/hooks/system/useListPage';
import { columns, superQuerySchema } from '/@/api/biz/TestEmployee.data';
import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from '/@/api/biz/TestEmployee.api';
import { downloadFile } from '/@/utils/common/renderUtils';
import TestEmployeeModal from '/@/components/biz/TestEmployeeModal.vue'
