...
<script lang="ts" name="biz-bizWallQualityInfo" setup>
import { ref, reactive } from 'vue';
import { BasicTable, TableAction } from '/@/components/Table';
import { useModal } from '/@/components/Modal';
import { useListPage } from '/@/hooks/system/useListPage'
import BizWallQualityInfoModal from './components/BizWallQualityInfoModal.vue'
import { columns, searchFormSchema, superQuerySchema } from './BizWallQualityInfo.data';
import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './BizWallQualityInfo.api';
