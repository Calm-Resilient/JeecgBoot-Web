            ...
            <div class="aui-form">
                ...
                <div class="aui-formBox aui-formEwm">
                        ...
                        <form>
                            ...
                            <div class="aui-form-box">
                                <div class="aui-account" style="padding: 30px 0">
                                    <div class="aui-ewm">
                                        <QrCode :value="qrCodeUrl" class="enter-x flex justify-center xl:justify-start"
                                            :width="280" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="aui-flex" :class="`${prefixCls}-sign-in-way`">
                        ...
                        <div class="aui-flex-box">
                            <div class="aui-third-login">
                                <a href="" title="企业微信" @click="onThirdLogin('wechat_enterprise')"><icon-font
